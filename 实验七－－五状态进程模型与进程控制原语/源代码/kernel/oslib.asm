...
screen_init_last_line:              
	...
	mov byte [es:bx],' '
	inc bx
	mov byte [es:bx],01101111B;font color
	inc bx
	cmp bx,cx
	jle loop_2
...
saveall_reg_seg:
	...
	push si
ret
global restart_flags
restart_flags:	 ;for dofork
	mov bp,sp
	mov ecx,0
	mov [ bp+20],ecx
	mov cx,[ _flags]
